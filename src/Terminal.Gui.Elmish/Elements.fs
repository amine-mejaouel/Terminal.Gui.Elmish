...
type TerminalElement (props:IProperty list) =
    ...
    member this.setProps (element: View, props) =
        // Properties
        ...
        props |> Interop.getValue<MouseState> "view.highlightStates" |> Option.iter (fun v -> element.HighlightStates <- v )
        ...
        props |> Interop.getValue<IMouseHeldDown> "view.mouseHeldDown" |> Option.iter (fun v -> element.MouseHeldDown <- v )
        props |> Interop.getValue<bool> "view.needsDraw" |> Option.iter (fun v -> element.NeedsDraw <- v )
        props |> Interop.getValue<bool> "view.preserveTrailingSpaces" |> Option.iter (fun v -> element.PreserveTrailingSpaces <- v )
        props |> Interop.getValue<string> "view.schemeName" |> Option.iter (fun v -> element.SchemeName <- v )
        ...
        props |> Interop.getValue<ViewportSettingsFlags> "view.viewportSettings" |> Option.iter (fun v -> element.ViewportSettings <- v )
        ...
        // Events
        props |> Interop.getValue<HandledEventArgs->unit> "view.accepting" |> Option.iter (fun v -> Interop.setEventHandler <@ element.Accepting @> v element)
        props |> Interop.getValue<AdvanceFocusEventArgs->unit> "view.advancingFocus" |> Option.iter (fun v -> Interop.setEventHandler <@ element.AdvancingFocus @> v element)
        props |> Interop.getValue<EventArgs->unit> "view.borderStyleChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.BorderStyleChanged @> v element)
        ...
        props |> Interop.getValue<DrawEventArgs->unit> "view.clearedViewport" |> Option.iter (fun v -> Interop.setEventHandler <@ element.ClearedViewport @> v element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.clearingViewport" |> Option.iter (fun v -> Interop.setEventHandler <@ element.ClearingViewport @> v element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.commandNotBound" |> Option.iter (fun v -> Interop.setEventHandler <@ element.CommandNotBound @> v element)
        ...
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawComplete" |> Option.iter (fun v -> Interop.setEventHandler <@ element.DrawComplete @> v element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingContent" |> Option.iter (fun v -> Interop.setEventHandler <@ element.DrawingContent @> v element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingSubViews" |> Option.iter (fun v -> Interop.setEventHandler <@ element.DrawingSubViews @> v element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingText" |> Option.iter (fun v -> Interop.setEventHandler <@ element.DrawingText @> v element)
        ...
        props |> Interop.getValue<HasFocusEventArgs->unit> "view.focusedChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.FocusedChanged @> v element)
        props |> Interop.getValue<EventArgs<Rectangle>->unit> "view.frameChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.FrameChanged @> v element)
        props |> Interop.getValue<VisualRoleEventArgs->unit> "view.gettingAttributeForRole" |> Option.iter (fun v -> Interop.setEventHandler <@ element.GettingAttributeForRole @> v element)
        props |> Interop.getValue<ResultEventArgs<Scheme>->unit> "view.gettingScheme" |> Option.iter (fun v -> Interop.setEventHandler <@ element.GettingScheme @> v element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.handlingHotKey" |> Option.iter (fun v -> Interop.setEventHandler <@ element.HandlingHotKey @> v element)
        ...
        props |> Interop.getValue<Key->unit> "view.keyDownNotHandled" |> Option.iter (fun v -> Interop.setEventHandler <@ element.KeyDownNotHandled @> v element)
        props |> Interop.getValue<Key->unit> "view.keyUp" |> Option.iter (fun v -> Interop.setEventHandler <@ element.KeyUp @> v element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseClick" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseClick @> v element )
        props |> Interop.getValue<CancelEventArgs->unit> "view.mouseEnter" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseEnter @> v element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseEvent" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseEvent @> v element)
        props |> Interop.getValue<EventArgs->unit> "view.mouseLeave" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseLeave @> v element)
        props |> Interop.getValue<EventArgs<MouseState>->unit> "view.mouseStateChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseStateChanged @> v element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseWheel" |> Option.iter (fun v -> Interop.setEventHandler <@ element.MouseWheel @> v element)
        ...
        props |> Interop.getValue<ValueChangedEventArgs<Scheme>->unit> "view.schemeChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SchemeChanged @> v element)
        props |> Interop.getValue<ValueChangingEventArgs<Scheme>->unit> "view.schemeChanging" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SchemeChanging @> v element)
        props |> Interop.getValue<ValueChangedEventArgs<string>->unit> "view.schemeNameChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SchemeNameChanged @> v element)
        props |> Interop.getValue<ValueChangingEventArgs<string>->unit> "view.schemeNameChanging" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SchemeNameChanging @> v element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.selecting" |> Option.iter (fun v -> Interop.setEventHandler <@ element.Selecting @> v element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.subViewAdded" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SubViewAdded @> v element)
        props |> Interop.getValue<LayoutEventArgs->unit> "view.subViewLayout" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SubViewLayout @> v element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.subViewRemoved" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SubViewRemoved @> v element)
        props |> Interop.getValue<LayoutEventArgs->unit> "view.subViewsLaidOut" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SubViewsLaidOut @> v element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.superViewChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.SuperViewChanged @> v element)
        ...
        props |> Interop.getValue<string->unit> "view.titleChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.TitleChanged @> (fun arg -> v arg.Value) element)
        props |> Interop.getValue<App.CancelEventArgs<string>->unit> "view.titleChanging" |> Option.iter (fun v -> Interop.setEventHandler <@ element.TitleChanging @> v element)
        ...
        props |> Interop.getValue<unit->unit> "view.visibleChanging" |> Option.iter (fun v -> Interop.setEventHandler <@ element.VisibleChanging @> (fun _ -> v()) element)
...
module ViewElement =
    ...
    let removeProps (element: View) props =
        ...
        props |> Interop.getValue<MouseState> "view.highlightStates" |> Option.iter (fun _ -> element.HighlightStates <- Unchecked.defaultof<_> )
        ...
        props |> Interop.getValue<IMouseHeldDown> "view.mouseHeldDown" |> Option.iter (fun _ -> element.MouseHeldDown <- Unchecked.defaultof<_> )
        props |> Interop.getValue<bool> "view.needsDraw" |> Option.iter (fun _ -> element.NeedsDraw <- Unchecked.defaultof<_> )
        ...
        props |> Interop.getValue<string> "view.schemeName" |> Option.iter (fun _ -> element.SchemeName <- Unchecked.defaultof<_> )
        ...
        props |> Interop.getValue<TabBehavior option> "view.tabStop" |> Option.iter (fun _ -> element.TabStop <- Unchecked.defaultof<_>  |> Option.toNullable)
        ...
        props |> Interop.getValue<ViewportSettingsFlags> "view.viewportSettings" |> Option.iter (fun _ -> element.ViewportSettings <- Unchecked.defaultof<_> )
        ...
        // Events
        props |> Interop.getValue<HandledEventArgs->unit> "view.accepting" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.Accepting @> element)
        props |> Interop.getValue<AdvanceFocusEventArgs->unit> "view.advancingFocus" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.AdvancingFocus @> element)
        props |> Interop.getValue<EventArgs->unit> "view.borderStyleChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.BorderStyleChanged @> element)
        ...
        props |> Interop.getValue<DrawEventArgs->unit> "view.clearedViewport" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.ClearedViewport @> element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.clearingViewport" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.ClearingViewport @> element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.commandNotBound" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.CommandNotBound @> element)
        ...
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawComplete" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.DrawComplete @> element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingContent" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.DrawingContent @> element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingSubViews" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.DrawingSubViews @> element)
        props |> Interop.getValue<DrawEventArgs->unit> "view.drawingText" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.DrawingText @> element)
        ...
        props |> Interop.getValue<HasFocusEventArgs->unit> "view.focusedChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.FocusedChanged @> element)
        props |> Interop.getValue<EventArgs<Rectangle>->unit> "view.frameChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.FrameChanged @> element)
        props |> Interop.getValue<VisualRoleEventArgs->unit> "view.gettingAttributeForRole" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.GettingAttributeForRole @> element)
        props |> Interop.getValue<ResultEventArgs<Scheme>->unit> "view.gettingScheme" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.GettingScheme @> element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.handlingHotKey" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.HandlingHotKey @> element)
        ...
        props |> Interop.getValue<Key->unit> "view.keyDownNotHandled" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.KeyDownNotHandled @> element)
        props |> Interop.getValue<Key->unit> "view.keyUp" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.KeyUp @> element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseClick" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseClick @> element)
        props |> Interop.getValue<CancelEventArgs->unit> "view.mouseEnter" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseEnter @> element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseEvent" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseEvent @> element)
        props |> Interop.getValue<EventArgs->unit> "view.mouseLeave" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseLeave @> element)
        props |> Interop.getValue<EventArgs<MouseState>->unit> "view.mouseStateChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseStateChanged @> element)
        props |> Interop.getValue<MouseEventArgs->unit> "view.mouseWheel" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.MouseWheel @> element)
        ...
        props |> Interop.getValue<ValueChangedEventArgs<Scheme>->unit> "view.schemeChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SchemeChanged @> element)
        props |> Interop.getValue<ValueChangingEventArgs<Scheme>->unit> "view.schemeChanging" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SchemeChanging @> element)
        props |> Interop.getValue<ValueChangedEventArgs<string>->unit> "view.schemeNameChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SchemeNameChanged @> element)
        props |> Interop.getValue<ValueChangingEventArgs<string>->unit> "view.schemeNameChanging" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SchemeNameChanging @> element)
        props |> Interop.getValue<CommandEventArgs->unit> "view.selecting" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.Selecting @> element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.subViewAdded" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SubViewAdded @> element)
        props |> Interop.getValue<LayoutEventArgs->unit> "view.subViewLayout" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SubViewLayout @> element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.subViewRemoved" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SubViewRemoved @> element)
        props |> Interop.getValue<LayoutEventArgs->unit> "view.subViewsLaidOut" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SubViewsLaidOut @> element)
        props |> Interop.getValue<SuperViewChangedEventArgs->unit> "view.superViewChanged" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.SuperViewChanged @> element)
        ...
        props |> Interop.getValue<App.CancelEventArgs<string>->unit> "view.titleChanging" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.TitleChanging @> element)
        ...
        props |> Interop.getValue<unit->unit> "view.visibleChanging" |> Option.iter (fun _ -> Interop.removeEventHandler <@ element.VisibleChanging @> element)
...
type AdornmentElement(props:IProperty list) =
    ...
    member this.setProps (element: Adornment, props) =
...
type BarElement(props:IProperty list) =
    ...
    member _.setProps (element: Bar, props) =
        base.setProps(element, props)
...
type BorderElement(props:IProperty list) =
    ...
    member _.setProps (element: Border, props) =
        base.setProps(element, props)
...
type ButtonElement(props:IProperty list) =
    ...
    member _.setProps (element: Button, props) =
        base.setProps(element, props)
...
type CheckBoxElement(props:IProperty list) =
    ...
    member _.setProps (element: CheckBox, props) =
        base.setProps(element, props)
...
type ColorPickerElement(props:IProperty list) =
    ...
    member _.setProps (element: ColorPicker, props) =
        base.setProps(element, props)
...
type ColorPicker16Element(props:IProperty list) =
    ...
    member _.setProps (element: ColorPicker16, props) =
        base.setProps(element, props)
...
type ComboBoxElement(props:IProperty list) =
    ...
    member _.setProps (element: ComboBox, props) =
        base.setProps(element, props)
...
type DateFieldElement(props:IProperty list) =
    ...
    member _.setProps (element: DateField, props) =
        base.setProps(element, props)
...
type DatePickerElement(props:IProperty list) =
    ...
    member _.setProps (element: DatePicker, props) =
        base.setProps(element, props)
...
type DialogElement(props:IProperty list) =
    ...
    member _.setProps (element: Dialog, props) =
        base.setProps(element, props)
...
type FileDialogElement(props:IProperty list) =
    ...
    member _.setProps (element: FileDialog, props) =
        base.setProps(element, props)
...
type FrameViewElement(props:IProperty list) =
    ...
    member _.setProps (element: FrameView, props) =
        base.setProps(element, props)
...
type GraphViewElement(props:IProperty list) =
    ...
    member _.setProps (element: GraphView, props) =
        base.setProps(element, props)
...
type HexViewElement(props:IProperty list) =
    ...
    member _.setProps (element: HexView, props) =
        base.setProps(element, props)
...
type LabelElement(props:IProperty list) =
    ...
    member _.setProps (element: Label, props) =
        base.setProps(element, props)
...
type LegendAnnotationElement(props:IProperty list) =
    ...
    member _.setProps (element: LegendAnnotation, props) =
        base.setProps(element, props)
...
type LineElement(props:IProperty list) =
    ...
    member _.setProps (element: Line, props) =
        base.setProps(element, props)

        // Properties
        props |> Interop.getValue<Orientation> "line.orientation" |> Option.iter (fun v -> element.Orientation <- v )
        // Events
        props |> Interop.getValue<Orientation->unit> "line.orientationChanged" |> Option.iter (fun v -> Interop.setEventHandler <@ element.OrientationChanged @> (fun arg -> v arg.Value) element)
...
type LineViewElement(props:IProperty list) =
    ...
    member _.setProps (element: LineView, props) =
        base.setProps(element, props)
...
type ListViewElement(props:IProperty list) =
    ...
    member _.setProps (element: ListView, props) =
        base.setProps(element, props)
...
type MarginElement(props:IProperty list) =
    ...
    member _.setProps (element: Margin, props) =
        base.setProps(element, props)
...
type Menuv2Element(props:IProperty list) =
    ...
    member _.setProps (element: Menuv2, props) =
        base.setProps(element, props)
...
type PopoverMenuElement(props: IProperty list) =
    ...
    member _.setProps (element: PopoverMenu, props) =
        base.setProps(element, props)
...
type MenuBarItemv2Element(props: IProperty list) =
    ...
    member _.setProps (element: MenuBarItemv2, props) =
        base.setProps(element, props)
...
type MenuBarv2Element(props:IProperty list) =
    ...
    member _.setProps (element: MenuBarv2, props) =
        base.setProps(element, props)
...
type ShortcutElement(props:IProperty list) =
    ...
    member _.setProps (element: Shortcut, props) =
        base.setProps(element, props)
...
type MenuItemv2Element(props:IProperty list) =
    ...
    member this.setProps (element: MenuItemv2, props) =
        base.setProps(element, props)
...
type NumericUpDownElement<'a>(props:IProperty list) =
    ...
    member _.setProps (element: NumericUpDown<'a>, props) =
        base.setProps(element, props)
...
type OpenDialogElement(props:IProperty list) =
    ...
    member _.setProps (element: OpenDialog, props) =
        base.setProps(element, props)
...
type PaddingElement(props:IProperty list) =
    ...
    member _.setProps (element: Padding, props) =
        base.setProps(element, props)
...
type ProgressBarElement(props:IProperty list) =
    ...
    member _.setProps (element: ProgressBar, props) =
        base.setProps(element, props)
...
type RadioGroupElement(props:IProperty list) =
    ...
    member _.setProps (element: RadioGroup, props) =
        base.setProps(element, props)
...
type SaveDialogElement(props:IProperty list) =
    ...
    member _.setProps (element: SaveDialog, props) =
        base.setProps(element, props)
...
type ScrollBarElement(props:IProperty list) =
    ...
    member _.setProps (element: ScrollBar, props) =
        base.setProps(element, props)
...
type ScrollSliderElement(props:IProperty list) =
    ...
    member _.setProps (element: ScrollSlider, props) =
        base.setProps(element, props)
...
type SliderElement<'a>(props:IProperty list) =
    ...
    member _.setProps (element: Slider<'a>, props) =
        base.setProps(element, props)
...
type SliderElement(props:IProperty list) =
    ...
    member _.setProps (element: Slider, props) =
        base.setProps(element, props)
...
type SpinnerViewElement(props:IProperty list) =
    ...
    member _.setProps (element: SpinnerView, props) =
        base.setProps(element, props)
...
type StatusBarElement(props:IProperty list) =
    ...
    member _.setProps (element: StatusBar, props) =
        base.setProps(element, props)
...
type TabElement(props:IProperty list) =
    ...
    member _.setProps (element: Tab, props) =
        base.setProps(element, props)
...
type TabViewElement(props:IProperty list) =
    ...
    member _.setProps (element: TabView, props) =
        base.setProps(element, props)
...
type TableViewElement(props:IProperty list) =
    ...
    member _.setProps (element: TableView, props) =
        base.setProps(element, props)
...
type TextFieldElement(props:IProperty list) =
    ...
    member _.setProps (element: TextField, props) =
        base.setProps(element, props)
...
type TextValidateFieldElement(props:IProperty list) =
    ...
    member _.setProps (element: TextValidateField, props) =
        base.setProps(element, props)
...
type TextViewElement(props:IProperty list) =
    ...
    member _.setProps (element: TextView, props) =
        base.setProps(element, props)
...
type TileViewElement(props:IProperty list) =
    ...
    member _.setProps (element: TileView, props) =
        base.setProps(element, props)
...
type TimeFieldElement(props:IProperty list) =
    ...
    member _.setProps (element: TimeField, props) =
        base.setProps(element, props)
...
type ToplevelElement(props:IProperty list) =
    ...
    member _.setProps (element: Toplevel, props) =
        base.setProps(element, props)
...
type TreeViewElement<'a when 'a : not struct>(props:IProperty list) =
    ...
    member _.setProps (element: TreeView<'a>, props) =
        base.setProps(element, props)
...
type WindowElement(props:IProperty list) =
    ...
    member _.setProps (element: Window, props) =
        base.setProps(element, props)
...
type WizardElement(props:IProperty list) =
    ...
    member _.setProps (element: Wizard, props) =
        base.setProps(element, props)
...
type WizardStepElement(props:IProperty list) =
    ...
    member _.setProps (element: WizardStep, props) =
        base.setProps(element, props)

...
module internal PKey =
  ...
  type colorBarPKeys() =
    inherit viewPKeys()
    // Properties
    member val value: ISimplePropKey<int> = PropKey.Create.simple "colorBar.value"

    // Events
    member val valueChanged: IEventPropKey<EventArgs<int> -> unit> = PropKey.Create.event "colorBar.valueChanged_event"

  // BBar
  type bBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val gBar: ISimplePropKey<GBar> = PropKey.Create.simple "bBar.gBar"
    member val rBar: ISimplePropKey<RBar> = PropKey.Create.simple "bBar.rBar"
  ...
  type gBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val bBar: ISimplePropKey<BBar> = PropKey.Create.simple "gBar.bBar"
    member val rBar: ISimplePropKey<RBar> = PropKey.Create.simple "gBar.rBar"
  ...
  // LightnessBar
  type lightnessBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val hBar: ISimplePropKey<HueBar> = PropKey.Create.simple "lightnessBar.hBar"
    member val sBar: ISimplePropKey<SaturationBar> = PropKey.Create.simple "lightnessBar.sBar"
  ...
  // ComboListView
  type comboListViewPKeys() =
    inherit listViewPKeys()
    // Properties
    member val hideDropdownListOnClick: ISimplePropKey<bool> = PropKey.Create.simple "comboListView.hideDropdownListOnClick"
  ...
  type progressBarPKeys() =
    ...
    member val fraction: ISimplePropKey<float32> = PropKey.Create.simple "progressBar.fraction"
  ...
  type rBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val bBar: ISimplePropKey<BBar> = PropKey.Create.simple "rBar.bBar"
    member val gBar: ISimplePropKey<GBar> = PropKey.Create.simple "rBar.gBar"
  ...
  // SaturationBar
  type saturationBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val hBar: ISimplePropKey<HueBar> = PropKey.Create.simple "saturationBar.hBar"
    member val lBar: ISimplePropKey<LightnessBar> = PropKey.Create.simple "saturationBar.lBar"
    member val vBar: ISimplePropKey<ValueBar> = PropKey.Create.simple "saturationBar.vBar"
  ...
  // ShadowView
  type shadowViewPKeys() =
    inherit viewPKeys()
    // Properties
    member val orientation: ISimplePropKey<Orientation> = PropKey.Create.simple "shadowView.orientation"
    member val shadowStyle: ISimplePropKey<ShadowStyle> = PropKey.Create.simple "shadowView.shadowStyle"
  ...
  type valueBarPKeys() =
    inherit colorBarPKeys()
    // Properties
    member val hBar: ISimplePropKey<HueBar> = PropKey.Create.simple "valueBar.hBar"
    member val sBar: ISimplePropKey<SaturationBar> = PropKey.Create.simple "valueBar.sBar"
  ...
  let treeView<'T> = treeViewPKeys<'T> ()
  let valueBar = valueBarPKeys ()

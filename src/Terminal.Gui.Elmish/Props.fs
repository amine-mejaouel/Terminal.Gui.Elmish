...
type prop =
    ...
    static member inline highlightStates (value:MouseState) = Interop.mkprop "view.highlightStates" value
    ...
    static member inline mouseHeldDown (value:IMouseHeldDown) = Interop.mkprop "view.mouseHeldDown" value
    static member inline needsDraw (value:bool) = Interop.mkprop "view.needsDraw" value
    static member inline preserveTrailingSpaces (value:bool) = Interop.mkprop "view.preserveTrailingSpaces" value
    static member inline schemeName (value:string) = Interop.mkprop "view.schemeName" value
    ...
    static member inline viewportSettings (value:ViewportSettingsFlags) = Interop.mkprop "view.viewportSettings" value
    ...
    // Events
    static member inline accepting (handler:HandledEventArgs->unit) = Interop.mkprop "view.accepting" handler
    static member inline advancingFocus (handler:AdvanceFocusEventArgs->unit) = Interop.mkprop "view.advancingFocus" handler
    static member inline borderStyleChanged (handler:EventArgs->unit) = Interop.mkprop "view.borderStyleChanged" handler
    static member inline canFocusChanged (handler:unit->unit) = Interop.mkprop "view.canFocusChanged" handler
    static member inline clearedViewport (handler:DrawEventArgs->unit) = Interop.mkprop "view.clearedViewport" handler
    static member inline clearingViewport (handler:DrawEventArgs->unit) = Interop.mkprop "view.clearingViewport" handler
    static member inline commandNotBound (handler:CommandEventArgs->unit) = Interop.mkprop "view.commandNotBound" handler
    ...
    static member inline drawComplete (handler:DrawEventArgs->unit) = Interop.mkprop "view.drawComplete" handler
    static member inline drawingContent (handler:DrawEventArgs->unit) = Interop.mkprop "view.drawingContent" handler
    static member inline drawingSubViews (handler:DrawEventArgs->unit) = Interop.mkprop "view.drawingSubViews" handler
    static member inline drawingText (handler:DrawEventArgs->unit) = Interop.mkprop "view.drawingText" handler
    static member inline enabledChanged (handler:unit->unit) = Interop.mkprop "view.enabledChanged" handler
    static member inline focusedChanged (handler:HasFocusEventArgs->unit) = Interop.mkprop "view.focusedChanged" handler
    static member inline frameChanged (handler:EventArgs<Rectangle>->unit) = Interop.mkprop "view.frameChanged" handler
    static member inline gettingAttributeForRole (handler:VisualRoleEventArgs->unit) = Interop.mkprop "view.gettingAttributeForRole" handler
    static member inline gettingScheme (handler:ResultEventArgs<Scheme>->unit) = Interop.mkprop "view.gettingScheme" handler
    static member inline handlingHotKey (handler:CommandEventArgs->unit) = Interop.mkprop "view.handlingHotKey" handler
    ...
    static member inline keyDownNotHandled (handler:Key->unit) = Interop.mkprop "view.keyDownNotHandled" handler
    static member inline keyUp (handler:Key->unit) = Interop.mkprop "view.keyUp" handler
    static member inline mouseClick (handler:MouseEventArgs->unit) = Interop.mkprop "view.mouseClick" handler
    static member inline mouseEnter (handler:CancelEventArgs->unit) = Interop.mkprop "view.mouseEnter" handler
    static member inline mouseEvent (handler:MouseEventArgs->unit) = Interop.mkprop "view.mouseEvent" handler
    static member inline mouseLeave (handler:EventArgs->unit) = Interop.mkprop "view.mouseLeave" handler
    static member inline mouseStateChanged (handler:EventArgs->unit) = Interop.mkprop "view.mouseStateChanged" handler
    static member inline mouseWheel (handler:MouseEventArgs->unit) = Interop.mkprop "view.mouseWheel" handler
    static member inline removed (handler:SuperViewChangedEventArgs->unit) = Interop.mkprop "view.removed" handler
    static member inline schemeChanged (handler:ValueChangedEventArgs<Scheme>->unit) = Interop.mkprop "view.schemeChanged" handler
    static member inline schemeChanging (handler:ValueChangingEventArgs<Scheme>->unit) = Interop.mkprop "view.schemeChanging" handler
    static member inline schemeNameChanged (handler:ValueChangedEventArgs<string>->unit) = Interop.mkprop "view.schemeNameChanged" handler
    static member inline schemeNameChanging (handler:ValueChangingEventArgs<string>->unit) = Interop.mkprop "view.schemeNameChanging" handler
    static member inline selecting (handler:CommandEventArgs->unit) = Interop.mkprop "view.selecting" handler
    static member inline subViewAdded (handler:SuperViewChangedEventArgs->unit) = Interop.mkprop "view.subViewAdded" handler
    static member inline subViewLayout (handler:LayoutEventArgs->unit) = Interop.mkprop "view.subViewLayout" handler
    static member inline subViewRemoved (handler:SuperViewChangedEventArgs->unit) = Interop.mkprop "view.subViewRemoved" handler
    static member inline subViewsLaidOut (handler:LayoutEventArgs->unit) = Interop.mkprop "view.subViewsLaidOut" handler
    static member inline superViewChanged (handler:SuperViewChangedEventArgs->unit) = Interop.mkprop "view.superViewChanged" handler
    ...
    static member inline titleChanging (handler:App.CancelEventArgs<string>->unit) = Interop.mkprop "view.titleChanging" handler
    ...
    static member inline visibleChanging (handler:unit->unit) = Interop.mkprop "view.visibleChanging" handler
...
type adornment =
    // Properties
    static member inline diagnostics (value:ViewDiagnosticFlags) = Interop.mkprop "adornment.diagnostics" value
...
type bar =
    ...
    static member inline orientationChanging (handler:App.CancelEventArgs<Orientation>->unit) = Interop.mkprop "bar.orientationChanging" handler
...
type checkBox =
    ...
    static member inline radioStyle (value:bool) = Interop.mkprop "checkBox.radioStyle" value
    static member inline text (value:string) = Interop.mkprop "checkBox.text" value
    // Events
    static member inline checkedStateChanging (handler:ResultEventArgs<CheckState>->unit) = Interop.mkprop "checkBox.checkedStateChanging" handler
...
type colorPicker =
    ...
    // Events
    static member inline colorChanged (handler:ResultEventArgs<Color>->unit) = Interop.mkprop "colorPicker.colorChanged" handler
...
type colorPicker16 =
    ...
    static member inline selectedColor (value:ColorName16) = Interop.mkprop "colorPicker16.selectedColor" value
    // Events
    static member inline colorChanged (handler:ResultEventArgs<Color>->unit) = Interop.mkprop "colorPicker16.colorChanged" handler
...
type hexView =
    // Properties
    static member inline address (value:Int64) = Interop.mkprop "hexView.address" value
    static member inline addressWidth (value:int) = Interop.mkprop "hexView.addressWidth" value
    static member inline allowEdits (value:int) = Interop.mkprop "hexView.allowEdits" value
    static member inline readOnly (value:bool) = Interop.mkprop "hexView.readOnly" value
...
type line =
    ...
    static member inline orientationChanging (handler:App.CancelEventArgs<Orientation>->unit) = Interop.mkprop "line.orientationChanging" handler
...
type popoverMenu =
    ...
    static member inline root (value:IProperty list) = Interop.mkprop "popoverMenu.root.element" (Menuv2Element(value))
...
type menuV2 =
    ...
    // Events
    static member inline accepted (value: CommandEventArgs->unit) = Interop.mkprop "menuv2.accepted" value
    static member inline selectedMenuItemChanged (value: MenuItemv2->unit) = Interop.mkprop "menuv2.selectedMenuItemChanged" value
...
type numericUpDown<'a> =
    ...
    static member inline valueChanging (handler:App.CancelEventArgs<'a>->unit) = Interop.mkprop "numericUpDown`1.valueChanging" handler
...
type radioGroup =
    // Properties
    static member inline assignHotKeysToRadioLabels (value:bool) = Interop.mkprop "radioGroup.assignHotKeysToRadioLabels" value
    static member inline cursor (value:Int32) = Interop.mkprop "radioGroup.cursor" value
    static member inline doubleClickAccepts (value:bool) = Interop.mkprop "radioGroup.doubleClickAccepts" value
    ...
    static member inline orientationChanging (handler:App.CancelEventArgs<Orientation>->unit) = Interop.mkprop "radioGroup.orientationChanging" handler
...
type scrollBarView =
    // Properties
    static member inline autoShow (value:bool) = Interop.mkprop "scrollBar.autoShow" value
    static member inline increment (value:Int32) = Interop.mkprop "scrollBar.increment" value
    static member inline orientation (value:Orientation) = Interop.mkprop "scrollBar.orientation" value
    static member inline position (value:Int32) = Interop.mkprop "scrollBar.position" value
    static member inline scrollableContentSize (value:Int32) = Interop.mkprop "scrollBar.scrollableContentSize" value
    static member inline visibleContentSize (value:Int32) = Interop.mkprop "scrollBar.visibleContentSize" value
    // Events
    static member inline orientationChanged (handler:Orientation->unit) = Interop.mkprop "scrollBar.orientationChanged" handler
    static member inline orientationChanging (handler:CancelEventArgs<Orientation>->unit) = Interop.mkprop "scrollBar.orientationChanging" handler
    static member inline scrollableContentSizeChanged (handler:EventArgs<Int32>->unit) = Interop.mkprop "scrollBar.scrollableContentSizeChanged" handler
    static member inline sliderPositionChanged (handler:EventArgs<Int32>->unit) = Interop.mkprop "scrollBar.sliderPositionChanged" handler

// ScrollSlider
type scrollSlider =
    // Properties
    static member inline orientation (value:Orientation) = Interop.mkprop "scrollSlider.orientation" value
    static member inline position (value:Int32) = Interop.mkprop "scrollSlider.position" value
    static member inline size (value:Int32) = Interop.mkprop "scrollSlider.size" value
    static member inline sliderPadding (value:Int32) = Interop.mkprop "scrollSlider.sliderPadding" value
    static member inline visibleContentSize (value:Int32) = Interop.mkprop "scrollSlider.visibleContentSize" value
    // Events
    static member inline orientationChanged (handler:Orientation->unit) = Interop.mkprop "scrollSlider.orientationChanged" handler
    static member inline orientationChanging (handler:CancelEventArgs<Orientation>->unit) = Interop.mkprop "scrollSlider.orientationChanging" handler
    static member inline positionChanged (handler:EventArgs<Int32>->unit) = Interop.mkprop "scrollSlider.positionChanged" handler
    static member inline positionChanging (handler:CancelEventArgs<Int32>->unit) = Interop.mkprop "scrollSlider.positionChanging" handler
    static member inline scrolled (handler:EventArgs<Int32>->unit) = Interop.mkprop "scrollSlider.scrolled" handler
...
type shortcut =
    ...
    static member inline forceFocusColors (value:bool) = Interop.mkprop "shortcut.forceFocusColors" value
    ...
    static member inline bindKeyToApplication (value:bool) = Interop.mkprop "shortcut.bindKeyToApplication" value
...
type slider<'a> =
    ...
    static member inline orientationChanging (handler:App.CancelEventArgs<Orientation>->unit) = Interop.mkprop "slider`1.orientationChanging" handler
...
type tableView =
    ...
    static member inline collectionNavigator (value:ICollectionNavigator) = Interop.mkprop "tableView.collectionNavigator" value
...
type textField =
    ...
    static member inline captionColor (value:Terminal.Gui.Drawing.Color) = Interop.mkprop "textField.captionColor" value
    ...
    static member inline selectWordOnlyOnDoubleClick (value:bool) = Interop.mkprop "textField.selectWordOnlyOnDoubleClick" value
    ...
    static member inline useSameRuneTypeForWords (value:bool) = Interop.mkprop "textField.useSameRuneTypeForWords" value
    // Events
    static member inline textChanging (handler:ResultEventArgs<string>->unit) = Interop.mkprop "textField.textChanging" handler
...
type textView =
    ...
    static member inline inheritsPreviousAttribute (value:bool) = Interop.mkprop "textView.inheritsPreviousAttribute" value
    static member inline isDirty (value:bool) = Interop.mkprop "textView.isDirty" value
    static member inline isSelecting (value:bool) = Interop.mkprop "textView.isSelecting" value
    ...
    static member inline selectWordOnlyOnDoubleClick (value:bool) = Interop.mkprop "textView.selectWordOnlyOnDoubleClick" value
    ...
    static member inline useSameRuneTypeForWords (value:bool) = Interop.mkprop "textView.useSameRuneTypeForWords" value
    ...
    static member inline drawNormalColor (handler:CellEventArgs->unit) = Interop.mkprop "textView.drawNormalColor" handler
    static member inline drawReadOnlyColor (handler:CellEventArgs->unit) = Interop.mkprop "textView.drawReadOnlyColor" handler
    static member inline drawSelectionColor (handler:CellEventArgs->unit) = Interop.mkprop "textView.drawSelectionColor" handler
    static member inline drawUsedColor (handler:CellEventArgs->unit) = Interop.mkprop "textView.drawUsedColor" handler
    static member inline unwrappedCursorPosition (handler:Point->unit) = Interop.mkprop "textView.unwrappedCursorPosition" handler
    // Additional properties
    static member inline textChanged (value:string->unit) = Interop.mkprop "textView.textChanged" value
...
type treeView<'a when 'a : not struct> =
    ...
    static member inline colorGetter (value:Func<'a,Scheme>) = Interop.mkprop "treeView`1.colorGetter" value
